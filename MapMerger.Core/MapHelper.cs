        ...
        private static void InitColors(MapType type)
        {
            switch (type)
            {
                case MapType.Normal:
                    ...
                    break;
                case MapType.Alive:
                    Colors[50] = Color.FromRgb(101, (int)byte.MaxValue, (int)byte.MaxValue);
                    Colors[51] = Color.FromRgb((int)byte.MaxValue, 51, 51);
                    Colors[52] = Color.FromRgb((int)byte.MaxValue, 101, (int)byte.MaxValue);
                    Colors[53] = Color.FromRgb((int)byte.MaxValue, 138, (int)byte.MaxValue);
                    Colors[54] = Color.FromRgb(238, 254, (int)byte.MaxValue);
                    Colors[55] = Color.FromRgb(238, 254, (int)byte.MaxValue);
                    Colors[116] = Color.FromRgb(161, 162, (int)byte.MaxValue);
                    Colors[119] = Color.FromRgb(170, (int)byte.MaxValue, (int)byte.MaxValue);
                    break;
            }
